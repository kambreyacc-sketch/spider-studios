...
export default async function GamePage({params}:{params:Promise<{slug:string}>}){
 ...
 return <main className="subpage gameDetailPage">
  ...
  <footer className="siteFooter"><Link className="brand" href="/"><span className="brandMark"><img src={logo} alt="Spider Studios"/></span><span>SPIDER</span><b>STUDIOS</b></Link><Link href="/contact">Contact</Link><small>© {new Date().getFullYear()} Spider Studios</small></footer>
 </main>;
}
