...
export default function Home(){
 ...
 return <main>
  ...
  <section className="studioHero">
   <video className="heroVideo" autoPlay muted loop playsInline preload="auto" aria-hidden="true"><source src="https://dobig.com/banner.webm" type="video/webm"/></video><div className="heroVideoShade"/>
